...
{
  return this.http.post<{message:Number,result:Array<Scholarship>}>(this.url+"/api/applicants/getAll",{batch:batch});
}
...
{
  return this.http.post<{message:Number,result:Array<Scholarship>}>(this.url+"/api/applicants/getSelectedApplicants",{batch:batch});
}
}
